...
import { View, StyleSheet, FlatList, Image, TouchableOpacity, ActivityIndicator, ScrollView, Dimensions, RefreshControl } from 'react-native';
...
const DecorationScreen: React.FC = () => {
    ...
    const CATEGORY_ID = 2; // Decoration Category ID (Assuming ID 2)
    ...
    const decorationSubCategories = subCategories[CATEGORY_ID] || [];
    ...
    return (
        <ThemedSafeAreaView style={styles.container}>
            <View style={styles.header}>
                <View>
                    <ThemeText style={styles.title}>Decoration</ThemeText>
                    <ThemeText style={[styles.subtitle, { color: colors.textSecondary }]}>
                        Enhance your space with our decor
                    </ThemeText>
                </View>
            ...
            <View style={styles.subCategoriesContainer}>
                ...
                >
                    ...
                    {decorationSubCategories.map(sub => renderSubCategoryChip(sub))}
                </ScrollView>
            </View>
